...
public class ResponseGUI extends javax.swing.JDialog {
    ...
    boolean isService = requestType.equals("service");
    boolean isApprove = actionType.equals("approve");

    // Only show assignment/schedule for SERVICE approval
    boolean showAssignmentFields = isService && isApprove;

    assignDropdown.setVisible(showAssignmentFields);
    assignLBL.setVisible(showAssignmentFields);
    datePicker.setVisible(showAssignmentFields);
    scheduleLBL.setVisible(showAssignmentFields);

    commentTA.setEnabled(true);
    commentLBL.setText(isApprove ? "Remarks:" : "Reason for Rejection:");
    ...
    // ✅ Field validation:
    boolean isAssignmentRequired = assignDropdown.isVisible();

if (comment.isEmpty() || status == null || 
    (isAssignmentRequired && (assignedTo == null || assignedTo.isBlank() || selectedDate == null))) {
